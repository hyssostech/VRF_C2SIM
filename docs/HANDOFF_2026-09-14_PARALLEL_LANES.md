...
files). G-A 22:45Z (6f91feb) built+pinned; V2 LIVE 23:09Z proved the chain (PREREG_V2 RESULTS); runner stop rule FIXED+merged ff15a4e; STP-809 BUILT+merged 4cd84d7 (00:10Z) -> the G-A pin is STALE: rerun G-A before any run needs the 809 bridge (V13 runs on the 99B7B235 pin); N2b (abstract-graph SMS +
