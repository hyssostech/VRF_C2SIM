...
- C11 THE FIRST INSTRUMENT for any VRF behaviour question is the object's OWN CONSOLE at notify level 4. Silence at the vendor default level 1 is a configured outcome, not evidence.
...
- ALTITUDE is settled - read docs/VRF_ALTITUDE_FRAMES.md sec 5 + 7 before writing about burial, clamps or altitude frames; "buried therefore never moves" re-entered a third time on 2026-09-21.
