...
| 3 | Task-status (TASKCMPLT) reports to the C2SIM bus | D | every run since R9; AT SCALE 2026-09-07: two vendor completions per spaced run (003457Z, 103246Z) after 24-29 km legs; the interface's own arrival-evidence completion (C15) covers units the vendor holds behind a straggler - verification run 114026Z (P9) |
