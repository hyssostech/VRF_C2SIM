...
| A12 | RTI dialog once per reboot, scripted watcher; assistant rtiexec loopback connection (4.6.1) | Assistant-free works (per-process RTI_ASSISTANT_DISABLE + rid RTI_configureConnectionWithRid 1, RTI Ref 5.2.10) BUT the rid MUST be the RTIEXEC posture: UG52 5.5.1 p190 "You cannot use the MAK RTI in lightweight mode with VR-Forces" - the 2026-09-03 lightweight rid gave reflected=0 all night; the documented posture (RTI 5.0.1, config/rid-501-rtiexec-min.mtl = the 12 parameters an assistant rtiexec connection sets, headless rtiexec started by us, interface 127.0.0.1 via --deviceAddress/--hostAddressString + RTI_networkInterfaceAddr) reflects 62 entities (PREREG_52_RTIEXEC_2026-09-04). 5.2 runs on RTI 5.0.1, not 4.6.1 (user ruling) | UG52 5.5.1 p190, Tables 10/11; RTI UG 5.0.1 7.3; RESEARCH_52_HLA_CONNECTION_CONFIG_2026-09-04 | Dialog watcher retired; rtiexec/forwarder started per profile, never killed; rid-461-ridconfigured.mtl and rid-501-rtiexec.mtl are SUPERSEDED (kept as records) | N (done) |
