...
internal static class WatchVrfUsage
{
    ...
    public static readonly string[] Capabilities = { "capabilities", "con-selftest", "stop-file" };

    public const string StopFileFlag = "--stop-file";

    public static string[] Lines() => new[]
    {
        "usage: WatchVrf.exe [applicationNumber] [durationSecs] [sampleSecs] [federation] [--stop-file <path>]",
        ...
        "                     capabilities, con-selftest, stop-file) and exits 0. Sole argument.",
        "",
